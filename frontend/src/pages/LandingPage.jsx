    ...
    <div style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)" }} className="min-h-screen">
      ...
      <section className="px-6 md:px-10 max-w-6xl mx-auto pt-10 pb-16 md:pt-16 md:pb-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-semibold leading-tight mb-4" style={{ color: "var(--color-text)" }}>
            Security operations,
            <br />
            without the noise.
          </h1>
          <p className="text-base mb-7 max-w-md" style={{ color: "var(--color-text-muted)" }}>
